...
class Convertidor {
  void thompsonToNFA(AutomataT a) {
    List<TransicionNFA> tNFA = [];
    List<int> ep1 = [];
    print(a.estados);
    print("inicia algoritmo de conversion Epsilon closure");
    Map<String, int> mapEstados = new Map();
    List<int> finales = [];
    for (int q in a.estados) {
      ep1 = this.epsilonClosure(q, a.transiciones);
      if (ep1.contains(a.qfinal) && finales.indexOf(a.qfinal) == -1) {
        finales.add(q);
      }
    ...
    print("Estados finales ${finales.toString()}");
    print("termina epsilon closure");
  }
